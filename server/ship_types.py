...
HAULER_SHIPS = {
    "pinto_runner": ShipType(
        ...
        build_cost={"hull_plating": 2, "std_engine": 1, "cargo_expander": 1},
    ...
    "mule_freighter": ShipType(
        ...
        build_cost={"hull_plating": 4, "std_engine": 1, "cargo_expander": 2, "maneuver_rig": 1},
    ...
    "bison_mk3": ShipType(
        ...
        build_cost={"hull_plating": 6, "armor_plates": 2, "std_engine": 1, "cargo_expander": 3, "shield_generator": 1, "maneuver_rig": 1},
    ...
    "mammoth": ShipType(
        ...
        build_cost={"hull_plating": 12, "armor_plates": 4, "std_engine": 2, "cargo_expander": 4, "shield_generator": 1, "jump_drive": 1},
    ...
    "ox_hauler": ShipType(
        ...
        build_cost={"hull_plating": 10, "armor_plates": 3, "std_engine": 2, "cargo_expander": 3, "armor_repairer": 1, "maneuver_rig": 1},
    ...
    "clydesdale": ShipType(
        ...
        build_cost={"hull_plating": 20, "armor_plates_m": 4, "std_engine": 3, "cargo_expander": 6, "shield_gen_m": 1, "jump_drive": 1, "maneuver_rig": 1},
...
MINER_SHIPS = {
    "prospect_skiff": ShipType(
        ...
        build_cost={"hull_plating": 2, "std_engine": 1, "mining_laser": 1, "cargo_expander": 1},
    ...
    "rock_hopper": ShipType(
        ...
        build_cost={"hull_plating": 3, "armor_plates": 1, "std_engine": 1, "mining_laser": 1, "cargo_expander": 1, "shield_generator": 1},
    ...
    "strip_miner": ShipType(
        ...
        build_cost={"hull_plating": 6, "armor_plates": 2, "std_engine": 1, "strip_miner_mod": 1, "mining_laser": 1, "cargo_expander": 2, "shield_generator": 1},
    ...
    "excavator": ShipType(
        ...
        build_cost={"hull_plating": 8, "armor_plates": 2, "std_engine": 1, "strip_miner_mod": 1, "mining_laser": 1, "cargo_expander": 2, "shield_generator": 1, "survey_scanner": 1},
    ...
    "deep_core_borer": ShipType(
        ...
        build_cost={"hull_plating": 14, "armor_plates": 4, "std_engine": 2, "strip_miner_mod": 2, "mining_laser": 1, "cargo_expander": 3, "shield_gen_m": 1, "jump_drive": 1},
...
MILITARY_SHIPS = {
    "viper_interceptor": ShipType(
        ...
        build_cost={"hull_plating": 2, "std_engine": 1, "pulse_laser": 2, "shield_generator": 1, "afterburner": 1},
    ...
    "sentinel_corvette": ShipType(
        ...
        build_cost={"hull_plating": 6, "armor_plates": 2, "std_engine": 1, "railgun": 2, "missile_launcher": 1, "shield_generator": 1, "armor_repairer": 1},
    ...
    "warden_frigate": ShipType(
        ...
        build_cost={"hull_plating": 10, "armor_plates": 3, "std_engine": 2, "railgun_m": 2, "missile_launcher_m": 1, "shield_gen_m": 1, "armor_repairer": 1, "jump_drive": 1},
        description="Heavy enforcement frigate. Gate camps, blockade duty, anti-piracy ops."
    ),
}

ALL_SHIPS = {**HAULER_SHIPS, **MINER_SHIPS}
ALL_SHIPS_INCLUDING_MILITARY = {**HAULER_SHIPS, **MINER_SHIPS, **MILITARY_SHIPS}
