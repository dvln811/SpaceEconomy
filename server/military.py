...
MILITARY_SHIPS = {
    ...
    "tf_interceptor": MilitaryShipClass(
        id="tf_interceptor", name="Aquila", hull_class="fighter", faction="terran_fed",
    ...
    "tf_frigate": MilitaryShipClass(
        id="tf_frigate", name="Centurion", hull_class="frigate", faction="terran_fed",
    ...
    "tf_cruiser": MilitaryShipClass(
        id="tf_cruiser", name="Praetor", hull_class="cruiser", faction="terran_fed",
    ...
    "tf_destroyer": MilitaryShipClass(
        id="tf_destroyer", name="Tribune", hull_class="destroyer", faction="terran_fed",
    ...
    "tf_battlecruiser": MilitaryShipClass(
        id="tf_battlecruiser", name="Consul", hull_class="battlecruiser", faction="terran_fed",
    ...
    "tf_battleship": MilitaryShipClass(
        id="tf_battleship", name="Imperator", hull_class="battleship", faction="terran_fed",
    ...
    "tf_dreadnought": MilitaryShipClass(
        id="tf_dreadnought", name="Sovereign", hull_class="dreadnought", faction="terran_fed",
    ...
    "nc_scout": MilitaryShipClass(
        id="nc_scout", name="Spectre", hull_class="fighter", faction="science_collective",
    ...
    "nc_cruiser": MilitaryShipClass(
        id="nc_cruiser", name="Synthesis", hull_class="cruiser", faction="science_collective",
    ...
    "nc_carrier": MilitaryShipClass(
        id="nc_carrier", name="Hivemind", hull_class="carrier", faction="science_collective",
    ...
    "nc_frigate": MilitaryShipClass(
        id="nc_frigate", name="Axiom", hull_class="frigate", faction="science_collective",
    ...
    "nc_destroyer": MilitaryShipClass(
        id="nc_destroyer", name="Vector", hull_class="destroyer", faction="science_collective",
    ...
    "nc_battleship": MilitaryShipClass(
        id="nc_battleship", name="Paradigm", hull_class="battleship", faction="science_collective",
    ...
    "nc_battlecruiser": MilitaryShipClass(
        id="nc_battlecruiser", name="Theorem", hull_class="battlecruiser", faction="science_collective",
    ...
    "nc_dreadnought": MilitaryShipClass(
        id="nc_dreadnought", name="Singularity", hull_class="dreadnought", faction="science_collective",
    ...
    "mg_escort": MilitaryShipClass(
        id="mg_escort", name="Bulwark", hull_class="frigate", faction="merchants_guild",
    ...
    "mg_cruiser": MilitaryShipClass(
        id="mg_cruiser", name="Dividend", hull_class="cruiser", faction="merchants_guild",
    ...
    "mg_picket": MilitaryShipClass(
        id="mg_picket", name="Venture", hull_class="fighter", faction="merchants_guild",
    ...
    "mg_destroyer": MilitaryShipClass(
        id="mg_destroyer", name="Enforcer", hull_class="destroyer", faction="merchants_guild",
    ...
    "mg_battlecruiser": MilitaryShipClass(
        id="mg_battlecruiser", name="Sovereign", hull_class="battlecruiser", faction="merchants_guild",
    ...
    "mg_battleship": MilitaryShipClass(
        id="mg_battleship", name="Treasury", hull_class="battleship", faction="merchants_guild",
    ...
    "mg_dreadnought": MilitaryShipClass(
        id="mg_dreadnought", name="Monopoly", hull_class="dreadnought", faction="merchants_guild",
    ...
    "fa_skirmisher": MilitaryShipClass(
        id="fa_skirmisher", name="Wasp", hull_class="fighter", faction="free_states",
    ...
    "fa_frigate": MilitaryShipClass(
        id="fa_frigate", name="Horsefly", hull_class="frigate", faction="free_states",
    ...
    "fa_destroyer": MilitaryShipClass(
        id="fa_destroyer", name="Hornet", hull_class="destroyer", faction="free_states",
    ...
    "fa_battlecruiser": MilitaryShipClass(
        id="fa_battlecruiser", name="Thunderhead", hull_class="battlecruiser", faction="free_states",
    ...
    "fa_cruiser": MilitaryShipClass(
        id="fa_cruiser", name="Mantis", hull_class="cruiser", faction="free_states",
    ...
    "fa_battleship": MilitaryShipClass(
        id="fa_battleship", name="Avalanche", hull_class="battleship", faction="free_states",
    ...
    "fa_dreadnought": MilitaryShipClass(
        id="fa_dreadnought", name="Liberation", hull_class="dreadnought", faction="free_states",
    ...
    "ic_interceptor": MilitaryShipClass(
        id="ic_interceptor", name="Talon", hull_class="fighter", faction="iron_compact",
    ...
    "ic_frigate": MilitaryShipClass(
        id="ic_frigate", name="Bolt", hull_class="frigate", faction="iron_compact",
    ...
    "ic_cruiser": MilitaryShipClass(
        id="ic_cruiser", name="Anvil", hull_class="cruiser", faction="iron_compact",
    ...
    "ic_battlecruiser": MilitaryShipClass(
        id="ic_battlecruiser", name="Juggernaut", hull_class="battlecruiser", faction="iron_compact",
    ...
    "ic_battleship": MilitaryShipClass(
        id="ic_battleship", name="Warlord", hull_class="battleship", faction="iron_compact",
    ...
    "ic_dreadnought": MilitaryShipClass(
        id="ic_dreadnought", name="Colossus", hull_class="dreadnought", faction="iron_compact",
    ...
    "ic_destroyer": MilitaryShipClass(
        id="ic_destroyer", name="Hammer", hull_class="destroyer", faction="iron_compact",
    ...
    "crs_destroyer": MilitaryShipClass(
        id="crs_destroyer", name="Scourge", hull_class="destroyer", faction="corsairs",
    ...
    "crs_cruiser": MilitaryShipClass(
        id="crs_cruiser", name="Reaver", hull_class="cruiser", faction="corsairs",
    ...
    "crs_battlecruiser": MilitaryShipClass(
        id="crs_battlecruiser", name="Marauder", hull_class="battlecruiser", faction="corsairs",
    ...
    "crs_interceptor": MilitaryShipClass(
        id="crs_interceptor", name="Gnat", hull_class="fighter", faction="corsairs",
