...
def _init_local_space():
    ...
    local_space.load_system(p['system_id'], sys_obj.objects,
                            ...
                            anchor_obj_id=(p['intra_position'] if 'intra_position' in p.keys() else '') or '')
    # Place player
